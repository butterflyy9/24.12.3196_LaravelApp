...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <h2 class="text-2xl font-bold mb-6 text-gray800">
        Menyunting Pengaturan Event
    </h2>

    <form action="{{ route('admin.events.update', $event->id) }}"
          method="POST"
          enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadowsm border border-gray-200 mt-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb4">
            ...
            <div>
                ...
                <input type="datetime-local" name="date"
                       value="{{ $event->date }}"
                       class="w-full border border-gray300 p-2.5 rounded"
                       required>
            </div>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="location"
                   ...
                   class="w-full border border-gray-300 p2.5 rounded"
                   required>
        </div>
