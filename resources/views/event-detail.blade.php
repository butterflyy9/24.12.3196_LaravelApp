        ...
        <div class="lg:col-span-2 space-y-12">
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-wrap gap-6 text-slate-500 font-medium">
                    <div>Saturday, 16 Nov 2024</div>
                    <div>The Blue Note Lounge, Metropolis</div>
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-lg text-slate-600 leading-relaxed mt-4">
                    ...
                    Acara ini juga dilengkapi dengan food stall premium dan area networking yang nyaman.
                </p>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-3 text-slate-500">
                    <li>E-Ticket akan dikirimkan otomatis setelah pembayaran berhasil.</li>
                    <li>Tiket dapat discan di pintu masuk (Check-in).</li>
                    <li class="text-rose-500">Tiket yang sudah dibeli tidak dapat direfund.</li>
                </ul>
            </div>
